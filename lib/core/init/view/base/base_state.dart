...
abstract class BaseState<T extends StatefulWidget> extends State<T> {
  ...
  EdgeInsets insetsHorizontal(double val) => EdgeInsets.symmetric(
        horizontal: dynamicHeight(val),
      );

  //

  EdgeInsets insetsVertical(double val) => EdgeInsets.symmetric(
        vertical: dynamicHeight(val),
      );
